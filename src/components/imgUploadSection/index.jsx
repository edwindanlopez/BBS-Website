...
import { homePageFormSchema } from '../../utils/validationSchema';
        ...
        if (res.data.result === 'ok') {
          uploads.map((el, i) => {
            if (el.delete_token === deleteToken) {
              const currentState = Array.from(uploads);
            ...
            >
              ...
              <div>
                ...
                <p tw="w-11/12 mx-auto lg:w-full text-white max-w-sm text-center leading-6">
                  Upload a couple of photos showing us a close-up and full-frame
                  view. We&apos;ll help identifiying possible solutions that
                  will help you level up your space.
                </p>
              </div>
            </div>
